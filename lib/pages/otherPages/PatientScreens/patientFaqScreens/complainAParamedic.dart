...
class ComplainAParamedic extends StatelessWidget {
  const ComplainAParamedic({Key? key}) : super(key: key);
        ...
        physics: const BouncingScrollPhysics(),
         child: Column(
          ...
          Padding(
            ...
            child: Text("If you din not enjoy your service or if you have a conflict with the paramedic, write to us: open a chat with support via the side menu or write us at Support@medassist.com\n\n We look into all complaints and block drivers who violate the rules of our service.", 
            style: AppTextStyles.popins(
